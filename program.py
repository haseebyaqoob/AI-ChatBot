...
def is_last_message_from_sender(chat_log, sender_name="Albert"):
...
while True:
    ...
    if is_last_message_from_sender(chat_history):
        ...
        model="gpt-3.5-turbo",
        messages=[
            {"role": "system", "content": "You are a person named haseeb who speaks hindi as well as english. You are from Pakistan and you are a coder. Output should be the next chat response (text message only)"},
            {"role": "system", "content": "Do not start like this [21:02, 12/6/2024] Albert: "},
